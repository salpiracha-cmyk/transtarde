...
$modules = [
    ...
    'exports' => __DIR__ . '/exports-canary/index.html',
];
...
if ($id === 'exports') {
    $cssFile = __DIR__ . '/exports-canary/app.css';
    $jsFile = __DIR__ . '/exports-canary/app.js';
...
(()=>{
  ...
  const initial=getRemote(true);if(initial?.ok&&!Object.prototype.hasOwnProperty.call(initial.values||{},'transtrade_export_v2_operational')){applying=true;originalRemove.call(localStorage,'transtrade_export_v2_operational');applying=false}if(initial)applyRemote(initial,true);
