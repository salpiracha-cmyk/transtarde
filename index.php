...
$replace = $bootstrap . '<script src="admin/app.js?v=20260907-3"></script><script src="admin/accounts-override.js?v=20260907-1"></script><script src="admin/export-realization-master-override.js?v=20260908-1"></script>';
