(()=>{
  ...
  addEventListener('DOMContentLoaded',boot);setTimeout(boot,300);setTimeout(boot,1200);setInterval(()=>{bridgePohanch();bridgeExportCompletion();flush().then(showOutboxAttention)},30000);window.TT_ACCOUNTS_SOURCE_BRIDGE={flush,outbox};
})();