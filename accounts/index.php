...
$html = preg_replace('/<\/body>/i', '<script src="/offline-outbox.js?v=20260912-1"></script><script src="app-bundle.php?v=20260912-14"></script><script src="/brand-theme.js?v=20260913-2"></script></body>', $html, 1) ?? $html;
echo $html;
