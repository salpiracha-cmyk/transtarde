...
const mastersApi=fs.readFileSync(path.join(root,'main/api/masters.php'),'utf8');
const authStore=fs.readFileSync(path.join(root,'main/auth_store.php'),'utf8');
...
assert.match(modulePhp,/markSaveState\('Saved'\)/,'successful commits may show only the brief plain-language Saved state');
