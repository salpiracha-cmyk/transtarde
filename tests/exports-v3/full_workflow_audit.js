...
assert.equal((docs.sales.match(/class="docPage"/g)||[]).length,3,'standard Sales Contract must render exactly three specimen pages');assert.match(docs.sales,/A\. 25 KG/);assert.match(docs.sales,/B\. 10 KG/);assert.match(docs.sales,/Free from live insects/);assert.match(docs.sales,/Contract Reference/);assert.match(docs.sales,/PAYMENT TERMS|PAYMENT/);
