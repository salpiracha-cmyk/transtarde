...
assert.ok((docs.sales.match(/salesContractPage/g)||[]).length>=2,'Sales Contract pagination must be content driven');assert.match(docs.sales,/PAGE 1 OF /);assert.match(docs.sales,/A\. 25 KG/);assert.match(docs.sales,/B\. 10 KG/);assert.match(docs.sales,/Free from live insects/);assert.match(docs.sales,/Contract Reference/);assert.match(docs.sales,/PAYMENT TERMS|PAYMENT/);
