...
assert.match(docs.invoice,/LC-99881/);assert.match(docs.invoice,/FI-2026-0001/);assert.match(docs.packing,/MSCU123456-0/);assert.match(docs.packing,/SL001/);assert.match(docs.bl,/MSCU123456-0/);assert.match(docs.bl,/SL001/);assert.match(docs.bl,/MV TEST/);assert.match(docs.coo,/CERTIFICATE OF ORIGIN/);assert.match(docs.coo,/PRODUCT OF PAKISTAN/);assert.match(docs.coo,/135\.000 MTONS/);assert.match(docs.cover,/Meezan Bank/i);assert.match(docs.cover,/GD-001/);assert.match(docs.cover,/DHL123/);assert.equal(t.lotStatus(lot1),'Ready to complete');
