...
assert.match(app,/const invoiceReference=internalTG\?ttApprovedInvoiceReference\(s\.customs\?\.invoiceNo\|\|dc\.ref/,'TG covering letter must use the saved Customs invoice number');
