...
for(const label of ['Customers & Notify Parties','Export Quality & Specs','Documents Presented','Other Terms','Other Parties','Mills & Locations','Companies','Banks & Accounts'])assert.ok(source.includes(label),label+' icon is missing');
