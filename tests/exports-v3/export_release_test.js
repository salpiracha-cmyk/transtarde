...
assert.match(brandCss,/--tt-brand-main:#4f7650/,'approved medium green is locked');
assert.match(brandCss,/--tt-brand-ivory:#f4f0e6/,'approved ivory is locked');
assert.match(brandCss,/#printRoot,.printDoc/,'document output palette remains independent');
assert.match(brandJs,/TTI_header\\.png/,'official Transtrade logo is used');
assert.match(modulePhp,/brand-theme\\.css/);
assert.match(modulePhp,/brand-theme\\.js/);
assert.match(accountsPhp,/brand-theme\\.css/);
