...
(async()=>{
 ...
 page.on('pageerror',e=>console.error('PAGEERROR:',e.stack||e.message||String(e)));
 ...
 await page.locator('[data-workspace="production"]').click();await page.waitForTimeout(150);const productionText=await page.locator('.workspaceDetail').textContent();if(!productionText.includes('PRODUCTION INSTRUCTIONS'))throw new Error(`Production workspace did not render. Detail text: ${productionText}`);
