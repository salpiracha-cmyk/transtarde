...
(async()=>{
 ...
 await page.locator('[data-workspace="production"]').click();await page.waitForFunction(()=>document.querySelectorAll('.workspaceDetail').length===1&&document.querySelector('.workspaceDetail')?.textContent?.includes('PRODUCTION INSTRUCTIONS'),null,{timeout:3000});
