...
assert.match(consoleHtml,/admin\/app\.js\?v=20260923-master-delete-2/,'Super Admin JavaScript cache key is current');
assert.match(consoleHtml,/admin\/styles\.css\?v=20260923-master-delete-2/,'Super Admin stylesheet cache key is current');
