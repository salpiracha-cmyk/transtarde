...
const files=[...numbered,path.join(root,'exports','app.part18.txt'),path.join(root,'exports','app.part17.txt')];
...
if(!loader.includes("'app.part18.txt','app.part17.txt'"))throw new Error('Loader does not execute release hardening before final mount');
